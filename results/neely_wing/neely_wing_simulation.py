...
# from neely_wing_data import neely_wing_ii
# from neely_wing_data import neely_wing_iii
# from neely_wing_data import neely_wing_iv
# from neely_wing_data import neely_wing_v
# from neely_wing_data import neely_wing_vi
# from neely_wing_data import neely_wing_vii

#vis.plot_3D.plot_aircraft(neely_wing_i, title="NEELY WING I: 2.5-08-4416")
...
neely_wing_i_grids = aelast.functions.generate_aircraft_grids(
    aircraft_object=neely_wing_i, aircraft_grid_data=neely_wing_grid_data
)
# neely_wing_ii_grids = aelast.functions.generate_aircraft_grids(
#    aircraft_object=neely_wing_ii, aircraft_grid_data=neely_wing_grid_data
# )
# neely_wing_iii_grids = aelast.functions.generate_aircraft_grids(
#    aircraft_object=neely_wing_iii, aircraft_grid_data=neely_wing_grid_data
# )
# neely_wing_iv_grids = aelast.functions.generate_aircraft_grids(
#    aircraft_object=neely_wing_iv, aircraft_grid_data=neely_wing_grid_data
# )
# neely_wing_v_grids = aelast.functions.generate_aircraft_grids(
#    aircraft_object=neely_wing_v, aircraft_grid_data=neely_wing_grid_data
# )
# neely_wing_vi_grids = aelast.functions.generate_aircraft_grids(
#    aircraft_object=neely_wing_vi, aircraft_grid_data=neely_wing_grid_data
# )
# neely_wing_vii_grids = aelast.functions.generate_aircraft_grids(
#    aircraft_object=neely_wing_vii, aircraft_grid_data=neely_wing_grid_data
# )
...
ax, fig = vis.plot_3D2.generate_aircraft_grids_plot(
    neely_wing_i_grids["macrosurfaces_aero_grids"],
    title="NEELY WING I: 2.5-08-4416",
)
...
neely_wing_i_results = aelast.functions.calculate_aircraft_loads(
    aircraft_object=neely_wing_i,
    aircraft_grid_data=neely_wing_grid_data,
