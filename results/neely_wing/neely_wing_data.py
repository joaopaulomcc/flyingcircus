...
NACA Technical Note No.1270 - EXPERIMENTAL AND CALCULATED CHARACTERISTICS OF SEVERAL NACA 44-SERIES
...
neely_wing_i_wing = geo.objects.MacroSurface(
...
neely_wing_i = geo.objects.Aircraft(
    name="Neely Wing I - 2.5-08-4416",
    macrosurfaces=[neely_wing_i_wing],
