...
def test_generate_panel_matrix():
    ...
    panel_matrix = msh.generate_panel_matrix(xx, yy, zz)
    print(panel_matrix[0][0].col_point)
...
def test_generate_col_points_matrix():
    ...
    xx, yy, zz = msh.generate_mesh(wing, n_semi_wingspam_panels, n_chord_panels,
                                   wingspam_discretization_type, chord_discretization_type)
    col_points_matrix_xx, col_points_matrix_yy, col_points_matrix_zz = msh.generate_col_points_matrix(xx,
    yy, zz)
...
if __name__ == "__main__":
    ...
    print()
    # test_generate_mesh()
    # test_generate_panel_matrix()
    test_generate_col_points_matrix()