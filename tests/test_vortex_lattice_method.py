...
if __name__ == "__main__":
    ...
    execution_time = timeit.timeit(test_gamma_solver, setup='from __main__ import panel_vector, flow_velocity_vector, infinity_mult, wing', number=1) / 1
    ...
    execution_time = timeit.timeit(test_downwash_solver, setup='from __main__ import panel_vector, gamma, downwash, true_airspeed, density', number=1) / 1
    print(f"Total Execution Time: {execution_time} s")
